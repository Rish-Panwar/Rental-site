...
const CarCards = ({ car }) => {
    ...
    return (
        <div className='group rounded-xl overflow-hidden bg-white shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'
        onClick={()=> {navigate(`/car-details/${car._id}`); scrollTo(0,0)}}>
            <div className='relative h-48 overflow-hidden'>
                ...
                {car.isAvailable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-xs px-2
                py-1 rounded-full '>Available</p>}                
            ...
            <div className="p-4 sm:p-5">
                ...
                <div className="mt-2 grid grid-cols-2 gap-y-2 text-gray-500">
